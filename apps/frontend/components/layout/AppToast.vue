        ...
        >
            ...
            >
                <div
                    ...
                    :key="toast.id"
                    role="status"
                    class="pointer-events-auto w-[calc(100vw-2rem)] max-w-80 rounded-lg border p-4 backdrop-blur-xl sm:w-80"
                ...
                >
                    <div class="flex items-start gap-3">
                        ...
                        <button
                            class="shrink-0 rounded p-2 opacity-60 transition hover:opacity-100 sm:p-0.5"
...
function toastClasses(color: string): string {
    const map: Record<string, string> = {
        ...
        blue: "border-primary-500/30 bg-primary-500/10 text-primary-400",
    };
    return map[color] ?? "border-primary-500/30 bg-primary-500/10 text-primary-400";
}
