...
const reportTarget = ref<{ type: string; id: string }>({ type: "user_profile", id: slug });
const comments = ref<
    Array<{
        id: string;
...
async function handleAddComment() {
    if (!commentText.value.trim() || !authStore.accessToken) return;
...
function openReportModal(type: string, id: string) {
