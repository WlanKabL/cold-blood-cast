<template>
    <div class="mx-auto max-w-7xl space-y-6 p-6">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div class="glass-card stat-card rounded-xl p-5">
        ...
        <!-- Tabbed Content -->
        <UiTabs v-model="activeTab" :tabs="dashboardTabs">
            <!-- Overview Tab -->
            <div v-if="activeTab === 'overview'" class="space-y-8">
                <!-- Feeding Reminders -->
                <div>
                    <div class="mb-4 flex items-center justify-between">
                        <h2 class="section-heading text-fg text-lg font-semibold">
            ...
            <!-- Maintenance Tab -->
            <div v-if="activeTab === 'maintenance'" class="space-y-8">
                <!-- Enclosures Overview -->
                <div>
                    <div class="mb-4 flex items-center justify-between">
                        <h2 class="section-heading text-fg text-lg font-semibold">
                    ...
                    >
                        <div
                            v-for="i in 3"
                            :key="i"
                            class="glass-card h-40 animate-pulse rounded-xl"
                        />
                    </div>
                    <div
                    ...
                    <div v-else class="glass-card flex flex-col items-center rounded-xl py-12">
                        ...
                        <p class="text-fg-muted text-sm">
                            {{ $t("pages.dashboard.noEnclosures") }}
                        </p>
                        <NuxtLink
                            to="/enclosures"
...
const dashboardTabs = computed(() => [
    { key: "overview", label: t("pages.dashboard.tabs.overview"), icon: "lucide:layout-dashboard" },
    { key: "schedule", label: t("pages.dashboard.tabs.schedule"), icon: "lucide:calendar" },
    { key: "maintenance", label: t("pages.dashboard.tabs.maintenance"), icon: "lucide:wrench" },
]);
