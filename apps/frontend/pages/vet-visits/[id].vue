                ...
                <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <dd class="text-fg mt-1 text-sm">
                            ...
                            <span v-if="visit.veterinarian?.clinicName" class="text-fg-faint">
                                · {{ visit.veterinarian.clinicName }}</span
                            >
                        </dd>
                    </div>
                    <div>
                ...
                <div class="space-y-3">
                    ...
                    >
                        ...
                        <div class="flex-1">
                            ...
                            <p v-if="visit.sourceVisit.reason" class="text-fg-faint text-xs">
                ...
                <div v-if="documents?.length" class="space-y-2">
                    ...
                    >
                        ...
                        >
                            <Icon
                                :name="
                                    isImage(doc.upload.url) ? 'lucide:image' : 'lucide:file-text'
                                "
                                class="h-5 w-5"
                            />
                        </div>
