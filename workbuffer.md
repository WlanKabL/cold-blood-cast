...
| All existing pages                                                      | ✅     | dashboard, settings, login, register, admin/_, legal/_, sensors, enclosures, pets |
...
1. ✅ `config.ts` — add new env vars (ENCRYPTION*KEY, SMTP*_, UPLOAD*DIR, FRONTEND_URL, TELEGRAM*_, DISCORD\_\*)
